<template>
  <footer class="bg-white dark:bg-zinc-900 t-10">
    <div class="container px-6 py-12 mx-auto">
      ...
      <div class="flex items-center justify-between">
        <a href="https://github.com/sptjerry19">
          <img class="w-auto h-9" src="../assets/Jerry-29-10-2023.png" alt="" />
        </a>

        <div class="flex -mx-2">
          <a
            href="https://www.facebook.com/profile.php?id=100058441982148"
          ...
          <a
            href="https://github.com/sptjerry19"
            class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
            aria-label="Github"
          >
            <svg
